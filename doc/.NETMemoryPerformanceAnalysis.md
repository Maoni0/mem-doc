...
```
PS C:\Windows\Microsoft.NET\Framework64\v4.0.30319> (Get-Command C:\Windows\Microsoft.NET\Framework64\v4.0.30319\clr.dll).FileVersionInfo.FileVersion
4.8.4250.0 built by: NET48REL1LAST_C

PS C:\> (Get-Command C:\temp\coreclr.dll).FileVersionInfo.FileVersion
