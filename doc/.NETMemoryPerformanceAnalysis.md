...
If you have any kind of GC configs (as env vars or in your app/runtime config) please let us know. An example of a basic config is if you've configed to use Server GC. This can mean you are seeing very different memory usage from if you didn't set this config. 
